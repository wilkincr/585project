...
class DeepspeedStrategy(ABC):
    ...
    def get_ds_train_config(self, is_actor):
        ...
        ds_config["flops_profiler"] = {
                "enabled": True,
                "profile_step": 1,  # Step at which to profile
                "detailed": True,  # Provides a detailed breakdown
                "module_depth": 3,  # Depth of modules to profile
                "top_modules": 3,   # Number of top modules to display
                "output_file": "flops_profiler_report.txt"
            }
